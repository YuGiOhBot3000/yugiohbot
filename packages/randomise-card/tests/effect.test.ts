    ...
    it.each([
      {
        ...
        pendulumEffect: "",
        cardEffect:
          "Cannot be Normal Summoned/Set. Must be Special Summoned (from your hand) by shuffling 5 of your banished Dinosaur monsters into the Main Deck. Once per turn, when your opponent activates a Spell/Trap Card (Quick Effect): You can destroy 1 Dinosaur monster in your hand or face-up on your field, and if you do, negate the activation, and if you do that, destroy that card. If this card is sent to the GY by a card effect: You can add 1 'Evolution Pill' Spell from your Deck to your hand. You can only use this effect of 'Cardy McCardface' once per turn.\n",
      },
      {
        cardName: "Cardy McCardface",
        ...
        pendulumEffect:
          "You can target 1 'Abyss Actor' Pendulum Monster you control and 1 monster your opponent controls; switch control of both monsters, then destroy this card. You can only use this effect of 'Cardy McCardface' once per turn.",
        cardEffect:
          "You take no battle damage from attacks involving this card. Once per turn, during your Standby Phase: Give control of this card to your opponent. Once per turn, if control of this face-up card changes: Activate this effect; the owner of this card can destroy 1 Set 'Abyss Script' Spell in their Spell & Trap Zone.",
      },
      {
      ...
      ({ cardName, cardEffect, effect, cardType, pendulumEffect }) => {
        expect(parseEffect({ cardName, cardType, effect })).toEqual({
          pendulumEffect,
          cardEffect,
        });
      }
